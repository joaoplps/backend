...
Lembrando que o IDE utilizado para a criação de projetos em java é o NetBeans, e se faz necessário ler atentamente a documentação em cada código para que funcionem os
efeitos práticos de cada exemplo dado. Um ou mais códigos devem estar nos locais corretos para que tudo ocorra conforme o esperado.
